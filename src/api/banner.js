...
export const deleteSomeoneBannerListAPI = (params) => axios.get('/banner/delete',{params:params})
export const deleteAllBannerListAPI = (params) => axios.get('/banner/removeAll',{params:params})
export const updateBannerFlagAPI = (data) => axios.post("/banner/updateFlag",data);  